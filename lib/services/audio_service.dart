...
class AudioService {
  ...
  static const _allAudioFiles = [
    ...
    'voice_hero_leaf.mp3',
    'voice_hero_nova.mp3',
    'voice_picker_hero_blaze.wav',
    'voice_picker_hero_frost.wav',
    'voice_picker_hero_bolt.wav',
    'voice_picker_hero_shadow.wav',
    'voice_picker_hero_leaf.wav',
    'voice_picker_hero_nova.wav',
    'voice_picker_weapon_star_blaster.wav',
    'voice_picker_weapon_flame_sword.wav',
    'voice_picker_weapon_ice_hammer.wav',
    'voice_picker_weapon_lightning_wand.wav',
    'voice_picker_weapon_vine_whip.wav',
    'voice_picker_weapon_cosmic_burst.wav',
