...
## Growth Roadmap (Sticky + Viral)
1. **Habit lock-in**: Weekly Mission Pass + tomorrow teaser + daily streak protection.
2. **Collection loop**: Sticker/companion collection tied to worlds and events.
3. **Parent virality**: Shareable weekly progress card and parent challenge invitations.
4. **Session magic**: Dynamic events (double stars, boss days) with stronger surprise moments.
5. **Social pull**: Optional family leaderboard and co-op challenge tracks.
